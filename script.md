...
|------|-------|------------------|
| 1–2 | 1–4 | **Fully "real"**: Warm lighting, solid colors, photorealistic style, standard comic panel borders |
| 3 | 5 | Terminal shows wireframe grid—first glimpse of the green aesthetic, but _contained_ within the screen |
| 3 | 6 | **First bleed**: Faint scanlines on Dave's face; borders/gutters subtly "snap" toward UI geometry (darker, screen-like negative space) |
| "Page One" (opt.) | A–C | **Full wireframe**: Three identical Daves in green-on-black, framed as simulation instances. The "real" world is already absent here—this is inside the grid. |
| 5 | 7 | Terminal shows populated grid—the green aesthetic is now detailed and threatening |
| 5 | 8 | **Second bleed**: Obvious scanlines on Dave, translucent edges, room glitching; borders **and gutters** now read as terminal-window dividers (matching Panel 7's grid) |
| 6 | 9 | **Full collapse**: Everything is green-on-black wireframe. Dave is indistinguishable from the simulations. The "real" world is gone. |
...
- **The Shift (Panel 9 pullback)**: The line “How certain are you…” is **explicitly UI/system text** anchored to the terminal window chrome, not a bubble.
