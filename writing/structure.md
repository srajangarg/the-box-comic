...
other big topics:
    ...
    humanities anthropocentric views
        the world revolves around us

        evolution
        
        we are special (life essence). no we are made of the same things


        we discovered other galaxies exist only ~100 years ago


        the next frontier is consciousness
            solipsism by default

            DRH's: p-zombies make no sense
    ...
    memetics
        ...
        how memes haave moved to digital space
